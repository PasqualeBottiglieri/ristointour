...
const WHATSAPP_URL =
  "https://wa.me/393385940445?text=Ciao!%20Ho%20visitato%20ristointour.it%20e%20vorrei%20maggiori%20informazioni";
  ...
  return (
    <a
      ...
      className={`
        ...
        size-14 md:size-14 rounded-full
