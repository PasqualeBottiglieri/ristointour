...
interface EventTypesInputProps {
  defaultValue?: string[];
  suggestions?: string[];
}

export default function EventTypesInput({ defaultValue, suggestions = [] }: EventTypesInputProps) {
  ...
  const availableSuggestions = allSuggestions.filter((s) => !tags.includes(s));
    ...
    <div>
      ...
      <div className="flex gap-2 mb-3">
        <input
          ...
          placeholder="Aggiungi tipo evento..."
      ...
      <input type="hidden" name="eventTypes" value={JSON.stringify(tags)} />
    </div>
  );
}
